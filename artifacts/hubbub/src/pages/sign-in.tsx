  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-background px-4">
      <div className="w-full max-w-[440px] border border-[#1a3320] bg-[#07100a] shadow-[0_0_20px_rgba(0,255,65,0.2)] p-8">
        ...
        <div className="mt-4 border-t border-[#1a3320] pt-4 space-y-2">
          <p className="text-[#1a8a2e] text-xs font-mono text-center">
            No account?{" "}
            <Link href={`${basePath}/sign-up`} className="text-[#00ff41] hover:text-[#33ff55] transition-colors">
              Register
            </Link>
          </p>
          <p className="text-[#1a3320] text-xs font-mono text-center">
            Migrated from Replit?{" "}
            <Link href={`${basePath}/setup-password`} className="text-[#1a8a2e] hover:text-[#33ff55] transition-colors">
